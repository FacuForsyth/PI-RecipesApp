...
const getApiInfo = async (req, res) => {
  const apiUrl = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=4aa11f2e9c6345caa5fc55dae5f4054a&addRecipeInformation=true&number=100`);
